...
SHEET_HEADERS = [
    ...
    "Referral Credit", "Net Amount", "Extra", "Paid for", "Earnings"
]
...
def update_invoice_in_gsheet(data_dict, sheet_obj, original_inv_to_find):
    ...
    try:
        ...
        if row_idx_to_update:
            ...
            # or should be handled if re-writing the whole row. For overwrite, we typically update core data.
            row_values = [
                uid_to_save, 
                data_dict.get("Serial No.", ""), 
                data_dict.get("Ref. No.", ""),
